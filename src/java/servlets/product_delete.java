...
public class product_delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet product_delete</title>");
            out.println("</head>");
            out.println("<body>");
            out.println(request.getParameter("product_id"));
            out.println("<h1>Servlet product_delete at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sqlLogin = "DELETE FROM products where product_id=?";
            stmt = con.prepareStatement(sqlLogin);
            stmt.setString(1, request.getParameter("product_id"));
            stmt.execute();
